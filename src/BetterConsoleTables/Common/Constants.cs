...
namespace BetterConsoleTables
{
    public static class Ansi
    {
        ...
        public static readonly Dictionary<FontStyle, string> FontStyleLookup = new Dictionary<FontStyle, string>()
        {
            [FontStyle.Bold] = Codes.Enable.Bold,
            [FontStyle.Italic] = Codes.Enable.Italic,
            [FontStyle.Underline] = Codes.Enable.Underline,
            [FontStyle.Blink] = Codes.Enable.Blink,
            [FontStyle.CrossedOut] = Codes.Enable.CrossedOut,
            [FontStyle.Overline] = Codes.Enable.Overline
        };
